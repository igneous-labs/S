...
use crate::{
    jito_wsol_base_program_test, JitoWsolProgramTestArgs, MockPoolState, MockProtocolFeeBps,
};
...
/// });
/// ```
pub fn jito_wsol_flat_fee_program_test(
    args: JitoWsolProgramTestArgs,
    ...
    let (mut program_test, mut pool_state) = jito_wsol_base_program_test(args);
