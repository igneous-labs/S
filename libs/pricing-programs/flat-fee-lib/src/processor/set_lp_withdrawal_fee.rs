use flat_fee_interface::{
    ...
    SetLpWithdrawalFeeAccounts, SetLpWithdrawalFeeKeys,
};
...
use crate::{account_resolvers::SetLpWithdrawalFeeFreeArgs, utils::try_program_state_mut};

pub fn process_set_lp_withdrawal_fee_unchecked(
...
pub fn verify_set_lp_withdrawal_fee<'me, 'info>(
