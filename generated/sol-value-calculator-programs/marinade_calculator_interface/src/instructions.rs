...
pub enum MarinadeCalculatorProgramIx {
...
impl BorshSerialize for MarinadeCalculatorProgramIx {
...
impl MarinadeCalculatorProgramIx {
...
pub struct LstToSolAccounts<'me, 'info> {
    ...
    pub marinade_program_data: &'me AccountInfo<'info>,
}
#[derive(Copy, Clone, Debug)]
pub struct LstToSolKeys {
    ...
    ///The marinade program executable data
    pub marinade_program_data: Pubkey,
}
...
impl From<[Pubkey; UPDATE_LAST_UPGRADE_SLOT_IX_ACCOUNTS_LEN]> for UpdateLastUpgradeSlotKeys {
    fn from(pubkeys: [Pubkey; UPDATE_LAST_UPGRADE_SLOT_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            manager: pubkeys[0],
            state: pubkeys[1],
            marinade_program: pubkeys[2],
            marinade_program_data: pubkeys[3],
        }
    }
}
    ...
    for UpdateLastUpgradeSlotAccounts<'me, 'info>
{
    fn from(arr: &'me [AccountInfo<'info>; UPDATE_LAST_UPGRADE_SLOT_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            manager: &arr[0],
            state: &arr[1],
            marinade_program: &arr[2],
            marinade_program_data: &arr[3],
        }
    }
}
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
...
pub struct InitAccounts<'me, 'info> {
    ///The account paying for MarinadeCalculatorState's rent
