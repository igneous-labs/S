...
use s_controller_lib::{
    disable_lst_input_ix_by_mint_full, try_find_lst_mint_on_list, try_lst_state_list,
    DisableLstInputByMintFreeArgs, U8Bool,
};
...
async fn basic() {
    ...
    let ix = disable_lst_input_ix_by_mint_full(DisableLstInputByMintFreeArgs {
        lst_mint: jitosol::ID,
